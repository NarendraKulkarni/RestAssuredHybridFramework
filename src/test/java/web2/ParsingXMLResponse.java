	...
	
	{
		...
		/*given()
			...
			.then()
				...
				.body("TravelerinformationResponse.travelers.Travelerinformation[0].name[0]", equalTo("Developer"));
				*/
		...
		.when()
			...
			String travelerName = res.xmlPath().get("TravelerinformationResponse.travelers.Travelerinformation[0].name[0]").toString();
